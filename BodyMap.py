...
class BodyMap:
    def __init__(self):
        ...
        self.bmap = {'head': self.set_head,'legs':self.set_legs,'right leg':self.set_right_leg,
                     'left leg':self.set_left_leg,'right leg':self.set_right_leg,'right arm':self.set_right_arm,
                     'left arm':self.set_left_arm,'torso':self.set_torso,'arms':self.set_arms,'waist':self.set_waist,
    ...
    def set_left_arm(self,value):
        ...
        self.body_sil[380:1000, 0:265] = np.where(self.body_sil[380:1000, 0:265] == [1, 1, 1], self.body_sil[380:1000, 0:265], value)
    def set_right_arm(self,value):
        ...
        self.body_sil[385:940, 640:1289] = np.where(self.body_sil[385:940, 640:1289] == [1, 1, 1], self.body_sil[385:940, 640:1289], value)
